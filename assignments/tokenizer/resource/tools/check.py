...
FILES = ['tokenizer209.c', 'readme', 'EthicsOath.pdf']
...
if __name__ == '__main__':
    ...
    with open('.tokenizer209.c', 'wb') as f:
        f.write(tar.extractfile('tokenizer209.c').read())

    p = subprocess.run(['gcc209', '-o', '.tokenizer209', '.tokenizer209.c'])
